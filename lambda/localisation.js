...
module.exports = {
    es: {
        translation: {
            WELCOME_MSG: 'Hola %s. Soy tu agente personal. ¿Qué opcion deseas?: Opción uno, mi cumpleaños. Opción dos, mis gastos. Opción tres, tiempo sin hablar con %s. y Opción cuatro, mis gustos personales.',
            ...
            REPETIR_NOMBRE_MSG: 'Vaya parece que aun no me has dicho como es el nombre de la persona que quieres que te recuerde. Por ejemplo, diga el nombre es Enrique',
            NOMBRE_REGISTRADO_MSG: 'Se ha registrado correctamente su nombre. Inicio el contador de días a partir de hoy.',
